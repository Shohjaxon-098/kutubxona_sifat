...
class AppImages {
  ...
  final String rateDefault = '$assets$icons/default-rate.svg';
  ...
  final String handCoin = '$assets$icons/hand-coin.svg';
  final String barChart = '$assets$icons/bar-chart.svg';
  final String accountCircle = '$assets$icons/account-circle.svg';
  final String bookShelf = '$assets$icons/book-shelf.svg';
